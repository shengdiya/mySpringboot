...
<%
    ...
    User user1= (User) request.getSession().getAttribute("user");Integer roleId= (Integer) request.getSession().getAttribute("roleId");PlantService plantservice = (PlantService) request.getSession().getAttribute("plantservice");
%>
