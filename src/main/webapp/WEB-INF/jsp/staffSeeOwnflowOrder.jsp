	    ...
	    document.addEventListener("DOMContentLoaded", function() {
	        setTimeout(function() {
	            <% if(request.getAttribute("borrowing") != null) { %>
	                alert("${borrowing}");
	            <% } else if(request.getAttribute("flowReturnBook") != null) { %>
	                alert("${flowReturnBook}");
	            <% } %>
    ...
    <el-container style="height: 100vh;">
        <el-aside width="150px" class="el-menu-vertical-demo">
            <el-menu default-active="1" @select="handleSelect" background-color="#1F2D3D" text-color="#BCC1C7" active-text-color="#409EFF">
                ...
                <el-menu-item index="reviewed"><i class="el-icon-check"></i> 已审核</el-menu-item>
    ...
    new Vue({
        ...
        methods: {
            handleSelect(index) {
                ...
                switch (index) {
                    case 'pending':
                        this.loadPageContent('/book/staffSeeOwnflowOrderWating');
                        break;
                    case 'reviewed':
                        this.loadPageContent('/book/staffSeeOwnflowOrderReviewed');
                        break;
                    case 'finished':
                        this.loadPageContent('/book/staffSeeOwnflowOrderFinished');
                        break;
                }
            },
